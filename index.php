...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navMenu">
        ...
        <ul class="navbar-nav align-items-center ms-3">
          <li class="nav-item">
            <button class="btn btn-black" type="button"><a href="atualizar.php" style="color: inherit; text-decoration: none;">Entrar</a></button>
          </li>
          <li class="nav-item">
  ...
  <section class="banner">
    <div class="banner-content">
      <h1>Bella Vita</h1>
      <p>Autêntica Pizzaria Italiana</p>
      <button class="btn btn-banner">Faça login e confira tudo </button>
    </div>
  </section>
