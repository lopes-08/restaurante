...
function adicionarAoCarrinho($produto_id, $nome, $preco, $imagem, $quantidade = 1) {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['adicionar_carrinho'])) {
    ...
    adicionarAoCarrinho($produto_id, $nome, $preco, $imagem);
...
<head>
    ...
    <title>Cardápio - Bella Vita</title>
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navMenu">
                ...
                <ul class="navbar-nav mx-auto search-bar">
                    <form class="d-flex w-100 justify-content-center">
                        <input class="form-control" type="search" placeholder="Buscar produtos..." aria-label="Buscar">
                    ...
                    <li class="nav-item">
                        <button class="btn btn-black" type="button">
                            <a href="carrinho.php" style="color: inherit; text-decoration: none;">
                                ...
                                <span class="carrinho-badge"><?php echo contarItensCarrinho(); ?></span>
                            </a>
                        </button>
                    </li>
                    <li class="nav-item">
    ...
    <div class="fita-branca">
        <a href="usuario.php" class="btn-fita">Início</a>
        <a href="cardapio.php" class="btn-fita">Cardápio</a>
         <a href="acompanharpedido.php" class="btn-fita">Acompanhar pedido</a>
        <a href="carrinho.php" class="btn-fita">Carrinho <span class="carrinho-badge"><?php echo contarItensCarrinho(); ?></span></a>
    </div>

    <div class="container">
        <header>
            <h1>Cardápio Completo</h1>
            <p>Descubra nossos deliciosos pratos italianos</p>
        </header>
        ...
        <div class="produtos-grid">
            ...
            if(mysqli_num_rows($consulta) > 0){
                while($row = $consulta->fetch_assoc()){
                    ...
                    echo '    <form method="POST" action="" class="form-carrinho">';
                    echo '      <input type="hidden" name="produto_id" value="'.$row['id'].'">';
                    echo '      <input type="hidden" name="produto_nome" value="'.$row['nome'].'">';
                    echo '      <input type="hidden" name="produto_preco" value="'.$row['preco'].'">';
                    echo '      <input type="hidden" name="produto_imagem" value="'.$row['imagem_url'].'">';
                    echo '      <button type="submit" name="adicionar_carrinho" class="card-botao" data-produto="'.$row['id'].'">';
                    echo '        <i class="fas fa-cart-plus"></i> Adicionar ao Carrinho';
                    echo '      </button>';
                    echo '    </form>';
                    echo '  </div>';
                    echo '</div>';
    ...
    <script>
        ...
        // Efeito de adicionar ao carrinho
        document.querySelectorAll('button[name="adicionar_carrinho"]').forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                this.className = 'card-botao adicionado';
        ...
        document.getElementById('categoria').addEventListener('change', function() {
            ...
            cards.forEach(card => {
                ...
                if (titulo.includes(categoria) || descricao.includes(categoria)) {
                    card.style.display = 'block';
                } else {
                    card.style.display = 'none';
                }
